...
class County:
    ...
    def amount_per_year (self):
        ...
        table1 = Table().with_column("Levels", ["County Average", "State Average", "National Average"]).with_column("$ Spent", [amount_spent, County.stateDollarsSpent, County.nationalDollarsSpent])
        return table1 
